...
public class OnlineTimeAPI_1_13 extends OnlineTimeAPI {
    ...
    public Collection<OnlineTimeWorld> getWorlds() {
        return Bukkit.getWorlds().stream().map(OnlineTimeWorld_1_13::new).collect(Collectors.toList());
    }

    @Override
    public OnlineTimeWorld getWorld(String name) {
        return new OnlineTimeWorld_1_13(Bukkit.getWorld(name));
    }
